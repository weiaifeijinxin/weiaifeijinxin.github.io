...
async function getStats() {
    try {
        ...
        // 循环获取所有数据
        while (hasMore) {
            const response = await fetch(`https://timepill.api.northcity.top/1/classes/Statistics?limit=${limit}&skip=${skip}`, {
                method: 'GET',
                headers: {
...
async function recordVisit() {
    try {
        const response = await fetch('https://timepill.api.northcity.top/1/classes/Statistics', {
            method: 'POST',
            headers: {
                'X-Bmob-Application-Id': '075c9e426a01a48a81aa12305924e532',
                'X-Bmob-REST-API-Key': 'a92fd1416101a7ee4de0ee0850572b91',
